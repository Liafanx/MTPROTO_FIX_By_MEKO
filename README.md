...
<p align="center">
  · <a href="#Быстрый-старт">Установка в 1 клик</a> · <a href="https://github.com/Mekotofeuka/MTPROTO_FIX_By_MEKO/blob/main/docs.md">Документация</a> · <a href="#Как-работает-фикс">Как работает то?</a> · <a href="#Возможные-проблемыпочему-у-меня-может-не-работать">Решение проблем</a> ·
</p>
...
**Если есть желание погрузиться в данную тему ещё глубже, вы можете прочитать нашу документацию:
· <a href="https://github.com/Mekotofeuka/MTPROTO_FIX_By_MEKO/blob/main/docs.md">Документация (тык)</a> ·**
