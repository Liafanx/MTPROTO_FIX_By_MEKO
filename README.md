...
- Условные обозначения для понимания в сообществе:
  ...
  - V1 фикс(сообщества и реаниматора) - разделение клиентов по портам - все устройства на один порт, ios - на другой порт
  - V2 фикс - Использование SYN лимита, замена DROP на Reject, удаление использования невыгодного MSS, увеличение задержки с 1 на 1.1 сек, разделение пользователей по их TTL + Length, для понимания кто есть ios, а кто - другое устройство для применения к ним соответствующих правил, для ios - accept, для остальных - accept раз в 1.1 сек, иначе - reject
